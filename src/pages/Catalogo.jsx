  ...
  const productosPagina = productosFiltrados.slice(indexInicio, indexFin);
    ...
    <div className="mt-14 mb-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-4">
            ...
            <div key={index} className="border border-gray-300 p-4 rounded shadow hover:shadow-lg bg-white hover:scale-105 transition-transform duration-300 flex flex-col h-full">
                <img
                ...
                <h2 className="text-md font-semibold text-black mb-1 line-clamp-2">{producto.nombre}</h2>
                </div>
                <div className="mt-auto">
                <p className="text-lg font-bold text-green-600 mb-3">${producto.precio.toLocaleString()}</p>
                <button
